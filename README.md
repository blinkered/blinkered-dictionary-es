# Blinkered dictionary: Spanish

The Spanish word list, and the evidence for every word in it. A word is here because
**three independent collections of Spanish text were found to contain it** — not because a
...
143,024 of 201,655 candidates proved (70.9%), across 25
independent families, 24 of them checkable by a stranger. `status.json` carries
...
`MPL-1.1`. See
[`blinkered-attestation/candidates/es/LICENSE`](https://github.com/blinkered/blinkered-attestation/blob/main/candidates/es/LICENSE).
